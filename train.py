...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_epochs", nargs="+", type=int, default=[ 10,27,50,100,150])
    parser.add_argument("--save_epochs", nargs="+", type=int, default=[100,150])
    parser.add_argument("--quiet", action="store_true")
    parser.add_argument("--checkpoint_epochs", nargs="+", type=int, default=[50,100])
