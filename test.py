...
if __name__ == "__main__":
    ...
    # grad_ndc,grad_cov2d_inv,grad_color,grad_opacities,grad_color_square_sum,fragment_sum=litegs_fused.rasterize_backward(sorted_pointId,tile_start_index,packed_params,None,
