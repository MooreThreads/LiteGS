...
3. **Better Performance and Fewer Resources**: LiteGS achieves an 3.0x speed improvement over the original 3DGS implementation while reducing GPU memory usage by around 30%. These optimizations enhance training efficiency without compromising flexibility or readability.
...
Our experimental results demonstrate that even with kernel splitting to achieve modularity, LiteGS still delivers remarkable performance improvements. Specifically, compared to the original 3DGS implementation, LiteGS achieves a 3.0x speedup on the A100. Moreover, when compared to the TamingGS-integrated version of 3DGS, LiteGS still offers a 1.3x speedup. These results clearly underscore the effectiveness of our approach in enhancing training efficiency while maintaining high performance.
...
| LiteGS(A100)              | 08:55   | 08:01   | 09:08   | 08:10   | 08:35   | 07:29   | 07:25   | 07:50   | 07:15   |
